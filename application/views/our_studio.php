...
<div class="top-header-section">
			...
			<div class="section-spacing">
				<div class="our-fact">
					<div class="container">
						<div class="row">
							<div class="col-lg-6"><h2 class="main-title">Last year we proved that we’re the best Dance Services </h2></div>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="single-counter-box">
							        			<h2 class="number"><span class="timer" data-from="0" data-to="20" data-speed="1200" data-refresh-interval="5">0</span>+</h2>
							        			<p>Certified Trainer</p>
							        		</div> <!-- /.single-counter-box -->
										</div>
										<div class="col-sm-6">
											<div class="single-counter-box">
							        			<h2 class="number"><span class="timer" data-from="0" data-to="1300" data-speed="1200" data-refresh-interval="5">0</span>+</h2>
										...
										<div class="col-sm-6">
											<div class="single-counter-box">
							        			<h2 class="number"><span class="timer" data-from="0" data-to="280" data-speed="1200" data-refresh-interval="5">0</span>+</h2>
							        			<p>Features added</p>
							        		</div> <!-- /.single-counter-box -->
										</div>
									</div>
			...
			<div class="section-spacing">
				<div class="join-our-team">
					<img src="<?php echo base_url()?>asset/images/shape/17.png" alt="" class="shape">
					<div class="clearfix">
							...
							<div class="col-md-6">
								<div class="join-team">
									<div class="overlay">
										...
										<p>Explore openings at Smartly.io around the world and join our team of Humble Hungry Hunters.</p>
										<a href="#" class="inner-button">Sign Up</a>
									</div> <!-- /.overlay -->
								</div> <!-- /.join-team -->
							</div>
							<div class="col-md-6">
								<div class="meet-events">
									<div class="overlay">
										<h2 class="title">Meet Us At Events</h2>
										<p>Explore openings at Smartly.io around the world and join our team of Humble Hungry Hunters.</p>
										<a href="#" class="inner-button">Check Events</a>
									</div> <!-- /.overlay -->
								</div> <!-- /.join-team -->
							</div>
						</div>
						...
						<div class="client-slider">
							<div class="item">
								<div class="text-wrapper">
									<p>“My 9 year old shuffle-ball-steps her way through the day, twirls in the checkout line and chasses to the bus! Thank you for the incredible role models & opportunity. We Love You!”</p>
									<img src="<?php echo base_url()?>asset/images/home/3.jpg" alt="">
									<h6>Mahfuz RIad</h6>
									<span>Founder</span>
								</div>
							</div>
			...
			<div class="section-spacing">
				<div class="our-teachers">
					<img src="<?php echo base_url()?>asset/images/shape/19.png" alt="" class="main-shape">
					<div class="container">
						<div class="theme-title-two">
							<h2 class="main-title">Talent Dance Teacher</h2>
						...
						<div class="row">
							<div class="col-lg-4 col-md-6">
								<div class="single-teacher-block">
									<div class="img-box">
										<img src="<?php echo base_url()?>asset/images/team/5.jpg" alt="" class="team">
										<img src="<?php echo base_url()?>asset/images/shape/18.png" alt="" class="shape">
										<a href="#" class="more">+</a>
									</div>
									<div class="text">
										<h6>Kathy Portello</h6>
										<p>Head Teacher</p>
									</div>
								</div> <!-- /.single-teacher-block -->
							</div> <!-- /.col- -->
							<div class="col-lg-4 col-md-6">
								<div class="single-teacher-block">
									<div class="img-box">
										<img src="<?php echo base_url()?>asset/images/team/6.jpg" alt="" class="team">
										<img src="<?php echo base_url()?>asset/images/shape/18.png" alt="" class="shape">
										<a href="#" class="more">+</a>
									</div>
									<div class="text">
							...
							<div class="col-lg-4 col-md-6">
								<div class="single-teacher-block">
									<div class="img-box">
										<img src="<?php echo base_url()?>asset/images/team/7.jpg" alt="" class="team">
										<img src="<?php echo base_url()?>asset/images/shape/18.png" alt="" class="shape">
										<a href="#" class="more">+</a>
									</div>
									<div class="text">
			...
			<div class="partent-logo-section">
				<div class="container">
					<div id="partner-logo">
						<div class="item"><img src="<?php echo base_url()?>asset/images/logo/1.png" alt="logo"></div>
						<div class="item"><img src="<?php echo base_url()?>asset/images/logo/2.png" alt="logo"></div>
						<div class="item"><img src="<?php echo base_url()?>asset/images/logo/3.png" alt="logo"></div>
						<div class="item"><img src="<?php echo base_url()?>asset/images/logo/4.png" alt="logo"></div>
					</div>
				</div>
