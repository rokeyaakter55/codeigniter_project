								...
								<div class="col-lg-6 order-lg-last">
									<div class="text-wrapper">
										...
										<div class="theme-title-one">
											<h2 class="main-title"><?php echo $events_details->title ?> </h2>
										</div> <!-- /.theme-title-one -->
										<p><?php echo $events_details->details ?></p>
										<a href="#" class="button-one">Free</a>
									</div> <!-- /.text-wrapper -->
								</div>
								<div class="col-lg-6 order-lg-first"><img src="<?php echo base_url('uploads/'.$events_details->photo) ?>" alt="" class="event-img"></div>
							</div>
								...
								<div class="col-md-6">
									<div class="details-box">
										...
										<table>
											<tr>
												<td>Start:</td>
												<td><?php echo $events_details->start_time; ?></td>
											</tr>
											<tr>
												<td>End:</td>
												<td><?php echo $events_details->end_time; ?></td>
											</tr>
											<tr class="color-fix">
												<td>Cost:</td>
												<td>Free</td>
											...
											<tr class="color-fix">
												<td>Category :</td>
												<td><?php echo $events_details->category; ?></td>
											</tr>
										</table>
									</div> <!-- /.details-box -->
								</div>
								<div class="col-md-6">
									<div class="details-box">
										...
										<table>
											<tr>
												<td>Address:</td>
												<td><?php echo $events_details->address; ?></td>
											</tr>
											<tr class="color-fix">
												<td>Venue:</td>
												<td><?php echo $events_details->venue; ?></td>
											</tr>
											<tr class="color-fix">
												<td>Link:</td>
										...
										<div class="col-lg-5">
											<div class="clearfix">
												...
												<table>
													<tr>
														<td>Name:</td>
														<td><?php echo $events_details->organizer_name; ?></td>
													</tr>
													<tr>
														<td>Tainer:</td>
														<td><?php echo $events_details->organizer_trainer; ?></td>
													</tr>
													<tr class="color-fix">
														<td>Phone:</td>
														<td><?php echo $events_details->organizer_phone; ?></td>
													</tr>
													<tr class="color-fix">
														<td>Email :</td>
														<td><?php echo $events_details->organizer_email; ?></td>
													</tr>
												</table>
											</div> <!-- /.clearfix -->
										</div>
